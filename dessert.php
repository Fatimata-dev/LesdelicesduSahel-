...
//$id= 'id';
if ($connect) {
  $query = "SELECT titre,articles.id,contenu,image ,categorie_id FROM articles inner join categories on articles.categorie_id=categories.id where articles.categorie_id=2";
