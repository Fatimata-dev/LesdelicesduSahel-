...
<main>
 ...
 <div class="card-deck mx-auto my-5">
  <div class="card">
    <img class="card-img-top" src="assets/img/beignet.jpg" alt="Card image cap">
    <div class="card-body">
      <h5 class="card-title">Beignets</h5>
      <p class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
      <p class="card-text"><small class="text-muted"></small></p>
    </div>
  </div>
  <div class="card">
    <img class="card-img-top" src="assets/img/degue1.jpg" alt="Card image cap">
    <div class="card-body">
      <h5 class="card-title">Degué</h5>
      <p class="card-text">This card has supporting text below as a natural lead-in to additional content.</p>
      <p class="card-text"><small class="text-muted"></small></p>
    </div>
  </div>
  <div class="card">
    <img class="card-img-top" src="assets/img/sombi1.jpg" alt="Card image cap">
    <div class="card-body">
      <h5 class="card-title">Sombi</h5>
